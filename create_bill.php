...
if(isset($_POST['submit'])) {
    ...
    foreach ($_POST['product_id'] as $index => $pid) {
        ...
        // 🔒 Server-side protection (negative block)
        if($qty < 1){
            $qty = 1;
        }
        ...
        <table class="table table-bordered" id="productTable">
          ...
          <tbody>
            <tr>
              ...
              <!-- ✅ Quantity negative block -->
              <td>
                <input type="number" name="quantity[]" class="form-control" value="1" min="1" onchange="updateTotal(this)">
              </td>
...
function updateTotal(el) {
  ...
  let qtyInput = tr.querySelector('[name="quantity[]"]');
